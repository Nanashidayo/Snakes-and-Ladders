...
{
    public partial class AI4Ps : Form
    {
        // initial variables
        ...
        private void AI4Ps_Load(object sender, EventArgs e)
        {
            Coordinates();
            player_turn = Dice.One_Four(); // Decide who starts
            ...
            if (player_turn != 1) // If AI starts first, begin AI play
            {
                AI_Turn();
            }
            else
            {
                btnRoll.Enabled = true; // Enable roll button for Player 1
            }
        ...
        private void Check_Winner()
        {
            ...
            else if (p4_steps == 100) DeclareWinner("Yuzu.AI");
        ...
        public static class Dice
        {
            ...
            public static int One_Four() => random.Next(1, 2);
        ...
        private async void AI_Turn()
        {
            ...
            {
                btnRoll.Enabled = false;
                await Task.Delay(500); // Simulate AI thinking

                Main_Function(player_turn); // AI rolls

                if (!gameWon)
                {
                    if (player_turn == 1)
                    {
                        btnRoll.Enabled = true; // Give control back to player
                    }
                    else
                    {
        ...
        private void picBoxT1_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxT2_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxT3_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxT4_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxChar4_Click_1(object sender, EventArgs e)
        {
        ...
        private void picBoxDie_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxChar1_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxChar3_Click_1(object sender, EventArgs e)
        {

        }

        private void picBoxChar2_Click(object sender, EventArgs e)
        {
