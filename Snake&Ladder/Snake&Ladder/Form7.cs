...
{
    public partial class threePs : Form
    {
        // initial variables
        ...
        private void MovePieceStep(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                player_turn = (movingPlayer % 3) + 1; // Cycles through 1 -> 2 -> 3 -> 1
                lblTurn.Text = (player_turn == 1) ? "Momoi" :
                               (player_turn == 2) ? "Midori" : "Arisu";
        ...
        public static class Dice
        {
            ...
            public static int One_Three() => random.Next(1, 5);
